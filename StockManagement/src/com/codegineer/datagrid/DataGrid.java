...
public class DataGrid extends LinearLayout{
	...
	private void initHeader()
	{
		...
		for(int i = 0; i < mc.COLUMN_STYLE.size(); i++)
		{
			...
			HeaderView.setTextSize(DataCell.FontSize);
	...
	public void create()
	{
		...
		mTvNoData.setText(strNoDataText == null ? "데이터가 없습니다." : strNoDataText);
